...
jest.mock(
  'src/engine/core-modules/aventurine-config/constants/config-variables-masking-config',
  () => ({
...
jest.mock(
  'src/engine/core-modules/aventurine-config/utils/is-env-only-config-var.util',
  () => ({
